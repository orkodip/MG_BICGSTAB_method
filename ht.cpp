...
//MULTIGRID PRECONDITIONED BiCG-stab SOLVER
//GALERKIN COARSE GRID APPROXIMATION OF THE COEFFICIENT MATRIX
#include<iostream>
#include<fstream>
#include<cmath>
#include<time.h>
...
HEAT::HEAT():MG_BICGSTAB(I*J,1000)	//MG_BICGSTAB parameterized constructor
{
	int IMAX,JMAX;
	k0=new double*[J+2];
	TH=new double*[J+1];
